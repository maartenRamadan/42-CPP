...
unsigned int ClapTrap::getMeleeDamage() { return (this->meleeDamage); }
unsigned int ClapTrap::getRangeDamage() { return (this->rangeDamage); }
unsigned int ClapTrap::getHP() { return (this->HP); }
unsigned int ClapTrap::getEP() { return (this->EP); }
...
ClapTrap::print()
{
	...
	std::cout	<< "- maxEP: " << this->maxEP << std::endl;
