...
FragTrap::FragTrap(std::string n) : _name(n)
{
	...
	std::cout << "FragTrap " << this->_name << " succesfully constructed" << std::endl;
	return ;
}
...
{
	if (this->_HP == 0)
		std::cout << "FragTrap " << this->_name << " is dead right now... Try again later." << std::endl;
	else
		std::cout << "FragTrap " << this->_name << " fires range attack at " << target << std::endl;
	return ;
}
...
FragTrap::meleeAttack(std::string const & target)
{
	if (this->_HP == 0)
		...
		std::cout << "FragTrap " << this->_name << " does melee attack at " << target << std::endl;
	return ;
}
